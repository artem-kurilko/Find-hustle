package com.findyourhustle.search.engine.service;

import java.util.Optional;

import com.findyourhustle.search.engine.domain.Article;
import com.findyourhustle.search.engine.repository.ArticleRepository;
